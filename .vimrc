...
" => Spell checking
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Turn Czech spelllang
set spelllang=cs,en
if has("win16") || has("win32") || has("win64")
    set spellfile=~\vimfiles\spell\cs.utf-8.add
else
    set spellfile=~/.vim/spell/cs.utf-8.add
endif
set encoding=utf-8

" by default and stores into ~/.vim/spell/{spelllang}.{encoding}
